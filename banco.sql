...
rgAdmin varchar (12) not null,
cpfAdmin varchar(14) not null unique,
fotoAdmin varchar(200) not null,
telAdmin varchar(11) not null,
dataNascimento varchar(10) not null,
sexo  varchar(20) not null,
endereco varchar(200) not null,
...
select * from tbAdmin;
insert into tbAdmin (
nomeAdmin, rgAdmin, cpfAdmin, fotoAdmin, telAdmin, dataNascimento, sexo, endereco, senhaAdmin, dataCadastro
) values ("Camily Cruz", " 500311467-6", "486.526.058-74", "http://4.bp.blogspot.com/-Rl3bcaovZgo/VXnNaPVoe8I/AAAAAAAAKyU/tUyx5WiMtdw/s1600/ser%25C3%25A3o-sexys-as-pessoas-mais-ego%25C3%25ADstas-novo-estudo-revela-no-que-homens-e-mulheres-diferem.jpg",
"112993-0000", "19/02/2003", "Feminino", "rua rua123", "123", "04/02/2021");
